...
import { StrEncrypted } from './security.dto';
 ...
 */
export function encriptar(str: string, sign: string): StrEncrypted {
 ...
 */
export function desencriptar(str: StrEncrypted, sign: string): string {
  const keyBuffer = stringTo32ByteKey(sign);
